...
REM Set variables
set "scriptDir=C:\\windows_test8"
set "phpSdkDir=C:\\windows_test8\\php-sdk-binary-tools-master"
...
cd /d "C:\\windows_test8\\php-sdk-binary-tools-master"
@echo off
call phpsdk-vs16-x64.bat
cd /d "C:\\windows_test8\\php-sdk-binary-tools-master\\phpdev\\vc16\\x64\\php-8.2.21-src"
buildconf --force
